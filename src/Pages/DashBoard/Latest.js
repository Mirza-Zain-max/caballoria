            ...
            <Container>
                <Row className='justify-content-center my-4'>
                    <Col xs={12} md={8} lg={6} className='text-center'>
                        <span className='bg-dark text-light px-3  mt-5  d-inline-block fs_09 inter-medium' style={{letterSpacing:"4.2px"}}>LATEST POST AND BLOG</span>
                    </Col>
                </Row>
                <Row>
                    <Col className='mt-3 '>
                        <h3 className='text-center fs_24 inter-bold'>Stay Up To Date With Our Latest Posts <br /> And Blog</h3>
                    </Col>
                </Row>
